...
module.exports.getEmployeesByStatus = function (status) { // done
...
module.exports.getEmployeeByNum = function (num) { // done
...
module.exports.getEmployeesByManager = function (manager) { // done
...
module.exports.getEmployeesByDepartment = function (department) { // done
